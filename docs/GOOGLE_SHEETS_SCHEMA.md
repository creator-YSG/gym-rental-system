...
| payment_password | TEXT | O | 결제 비밀번호 (6자리 숫자) | 123456 |
...
```
| member_id | name   | phone         | payment_password | status | created_at          | updated_at          | notes    |
|-----------|--------|---------------|------------------|--------|---------------------|---------------------|----------|
| A001      | 홍길동 | 010-1234-5678 | 123456           | active | 2024-12-01 09:00:00 | 2024-12-01 10:05:00 |          |
| A002      | 김철수 | 010-2345-6789 | 654321           | active | 2024-12-01 09:30:00 | 2024-12-01 09:30:00 | VIP 회원 |
```
