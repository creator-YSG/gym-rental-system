...
## 시트 2: products (상품 가격표)

### 컬럼 구조

| 컬럼명 | 타입 | 필수 | 설명 | 예시 |
|--------|------|------|------|------|
| product_id | TEXT | O | 상품 고유 ID | P-UPPER-105 |
| gym_id | TEXT | O | 헬스장 ID | GYM001 |
| category | TEXT | O | 카테고리 | upper, lower, towel |
| size | TEXT | | 사이즈 | 95, 100, 105, XL, FREE |
| name | TEXT | O | 상품명 | 운동복 상의 105 |
| device_id | TEXT | O | 연결된 F-BOX 기기 ID | FBOX-UPPER-105 |
...
```
| product_id   | gym_id | category | size | name           | device_id       | stock | enabled | display_order | updated_at          |
|--------------|--------|----------|------|----------------|-----------------|-------|---------|---------------|---------------------|
| P-UPPER-095  | GYM001 | upper    | 95   | 운동복 상의 95  | FBOX-UPPER-095  | 15    | TRUE    | 1             | 2024-12-01 10:00:00 |
| P-UPPER-100  | GYM001 | upper    | 100  | 운동복 상의 100 | 1000  | FBOX-UPPER-100  | 14    | TRUE    | 2             | 2024-12-01 10:00:00 |
| P-UPPER-105  | GYM001 | upper    | 105  | 운동복 상의 105 | 1000  | FBOX-UPPER-105  | 13    | TRUE    | 3             | 2024-12-01 10:05:00 |
| P-LOWER-105  | GYM001 | lower    | 105  | 운동복 하의 105 | 1000  | FBOX-LOWER-105  | 14    | TRUE    | 13            | 2024-12-01 10:05:00 |
| P-TOWEL      | GYM001 | towel    |      | 수건            | 500   | FBOX-TOWEL-01   | 23    | TRUE    | 21            | 2024-12-01 10:05:00 |
```

### 데이터 흐름
- **Sheets → 라즈베리파이**: 부팅 시 상품 목록 동기화 (또는 수동 리프레시)
- **라즈베리파이 → Sheets**: 재고 변동 시 stock 업데이트

### 상품 관리
- 관리자가 Sheets에서 상품 추가/수정
- 라즈베리파이가 주기적으로 동기화하여 반영
- 횟수 기반: 1개 대여 = 1회 차감
...
| product_id | TEXT | O | 상품 ID | P-UPPER-105 |
| product_name | TEXT | | 상품명 | 운동복 상의 105 |
| device_id | TEXT | O | 기기 ID | FBOX-UPPER-105 |
...
```
| rental_id | member_id | locker | product_id   | product_name       | device_id       | qty | count_before | count_after | created_at          |
|-----------|-----------|--------|--------------|--------------------|-----------------| ----|--------------|-------------|---------------------|
| 1         | A001      | 105    | P-UPPER-105  | 운동복 상의 105     | FBOX-UPPER-105  | 1   | 10           | 9           | 2024-12-01 10:05:00 |
| 2         | A001      | 105    | P-LOWER-105  | 운동복 하의 105     | FBOX-LOWER-105  | 1   | 9            | 8           | 2024-12-01 10:05:01 |
| 3         | A001      | 105    | P-TOWEL      | 수건               | FBOX-TOWEL-01   | 1   | 8            | 7           | 2024-12-01 10:05:02 |
```
...
|--------|------|------|------|------|
| device_id | TEXT | O | 기기 ID | FBOX-UPPER-105 |
| product_id | TEXT | | 연결된 상품 ID | P-UPPER-105 |
| size | TEXT | | 사이즈 | 105 |
| stock | NUMBER | O | 현재 재고 | 14 |
| status | TEXT | O | 상태 | online, offline, error |
| last_heartbeat | DATETIME | | 마지막 하트비트 | 2024-12-01 10:10:00 |
| last_dispense | DATETIME | | 마지막 토출 시각 | 2024-12-01 10:05:00 |
| total_dispense_count | NUMBER | | 누적 토출 횟수 | 150 |
...
```
| device_id       | product_id  | size | stock | status | last_heartbeat      | last_dispense       | total_dispense_count | error_message | updated_at          |
|-----------------|-------------|------|-------|--------|---------------------|---------------------|----------------------|---------------|---------------------|
| FBOX-UPPER-105  | P-UPPER-105 | 105  | 14    | online | 2024-12-01 10:10:00 | 2024-12-01 10:05:00 | 150                  |               | 2024-12-01 10:10:00 |
| FBOX-LOWER-105  | P-LOWER-105 | 105  | 14    | online | 2024-12-01 10:10:00 | 2024-12-01 10:05:01 | 120                  |               | 2024-12-01 10:10:00 |
| FBOX-TOWEL-01   | P-TOWEL     |      | 23    | online | 2024-12-01 10:10:00 | 2024-12-01 10:05:02 | 280                  |               | 2024-12-01 10:10:00 |
| FBOX-UPPER-110  | P-UPPER-110 | 110  | 3     | online | 2024-12-01 10:10:00 | 2024-12-01 09:30:00 | 95                   | stock_low     | 2024-12-01 10:10:00 |
```

### 데이터 흐름
- **라즈베리파이 → Sheets**: 
  - Heartbeat 수신 시 last_heartbeat 업데이트
  - 토출 완료 시 stock, last_dispense, total_dispense_count 업데이트
  - 에러 발생 시 status, error_message 업데이트
